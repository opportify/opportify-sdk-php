...
class ExportRequest implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * Sets filters
     *
     * @param  array<string,mixed>|null  $filters  Field-level filters to apply to the export. Supports string filters (exact match, comma-separated, or arrays), numeric filters (exact values, arrays, or range objects with min/max), and nested field…
     * @return self
     */
