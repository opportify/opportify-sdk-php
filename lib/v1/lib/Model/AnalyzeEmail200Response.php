...
class AnalyzeEmail200Response implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     *
     * @param  string|null  $email_correction  Suggested corrected email address when auto-correction is confident. Present only when `enableAutoCorrection` is true and a correction exists.
     * @return self
     */
