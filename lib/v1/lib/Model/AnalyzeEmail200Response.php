...
class AnalyzeEmail200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'address_signals' => '\OpenAPI\Client\Model\AddressSignals',
        'email_dns' => '\OpenAPI\Client\Model\EmailDNS',
        'risk_report' => '\OpenAPI\Client\Model\RiskReportEmail',
        'domain' => '\OpenAPI\Client\Model\EmailDomain'
    ];
    ...
    */
     ...
     * Sets is_deliverable
     *
     * @param string $is_deliverable Checks if the email address exists and is deliverable using SMTP handshake simulation. This involves connecting to the mail server and issuing commands to verify deliverability. The possible answers…
     *
     * @return self
     */
     ...
     *
     * @param string $email_correction The corrected email address when the system is highly confident about a typo or misspelling. Always present; empty string when no correction is needed.
     *
     * @return self
     */
     ...
     *
     * @param string|null $email_auto_corrected_from The original email address provided in the request, before auto-correction was applied. This field is only present when `enableAutoCorrection` is `true` AND the system automatically applied a…
     *
     * @return self
     */
