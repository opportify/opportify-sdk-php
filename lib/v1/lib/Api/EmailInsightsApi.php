...
class EmailInsightsApi
{
    ...
    {
        [$response] = $this->analyzeEmailWithHttpInfo($analyze_email_request, $contentType);
    ...
    {
        [$response] = $this->createEmailBatchExportWithHttpInfo($job_id, $export_request, $contentType);
    ...
    {
        [$response] = $this->getEmailBatchExportStatusWithHttpInfo($job_id, $export_id, $contentType);
