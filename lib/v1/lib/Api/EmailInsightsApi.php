...
class EmailInsightsApi
{
    ...
    {
        list($response) = $this->batchAnalyzeEmailsWithHttpInfo($batch_analyze_emails_request, $contentType);
        return $response;
    }
    ...
    /**
     * Operation createEmailBatchExport
     *
    ...
    {
        list($response) = $this->createEmailBatchExportWithHttpInfo($job_id, $export_request, $contentType);
        return $response;
    }

    /**
     * Operation createEmailBatchExportWithHttpInfo
     *
     * Create Email Batch Export
     *
     * @param  string $job_id The unique identifier of the completed batch job. Format: uuid. Example: \&quot;84d22c8b-2cb6-4606-bfb1-361244a097e4\&quot;. (required)
    ...
    {
        $request = $this->createEmailBatchExportRequest($job_id, $export_request, $contentType);
    ...
    /**
     * Operation createEmailBatchExportAsync
     *
     * Create Email Batch Export
     *
     * @param  string $job_id The unique identifier of the completed batch job. Format: uuid. Example: \&quot;84d22c8b-2cb6-4606-bfb1-361244a097e4\&quot;. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createEmailBatchExportAsync($job_id, $export_request = null, string $contentType = self::contentTypes['createEmailBatchExport'][0])
    {
        return $this->createEmailBatchExportAsyncWithHttpInfo($job_id, $export_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createEmailBatchExportAsyncWithHttpInfo
     *
     * Create Email Batch Export
     *
     * @param  string $job_id The unique identifier of the completed batch job. Format: uuid. Example: \&quot;84d22c8b-2cb6-4606-bfb1-361244a097e4\&quot;. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createEmailBatchExportAsyncWithHttpInfo($job_id, $export_request = null, string $contentType = self::contentTypes['createEmailBatchExport'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createEmailBatchExportRequest($job_id, $export_request = null, string $contentType = self::contentTypes['createEmailBatchExport'][0])
    {

        // verify the required parameter 'job_id' is set
        if ($job_id === null || (is_array($job_id) && count($job_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $job_id when calling createEmailBatchExport'
            );
        }

        $resourcePath = '/email/batch/{jobId}/exports';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getEmailBatchExportStatus
     *
    ...
    {
        list($response) = $this->getEmailBatchExportStatusWithHttpInfo($job_id, $export_id, $contentType);
        return $response;
    }

    /**
     * Operation getEmailBatchExportStatusWithHttpInfo
     *
     * Get Email Batch Export Status
     *
     * @param  string $job_id The unique identifier of the batch job. Format: uuid. Example: \&quot;84d22c8b-2cb6-4606-bfb1-361244a097e4\&quot;. (required)
    ...
    {
        $request = $this->getEmailBatchExportStatusRequest($job_id, $export_id, $contentType);
    ...
    /**
     * Operation getEmailBatchExportStatusAsync
     *
     * Get Email Batch Export Status
     *
     * @param  string $job_id The unique identifier of the batch job. Format: uuid. Example: \&quot;84d22c8b-2cb6-4606-bfb1-361244a097e4\&quot;. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailBatchExportStatusAsync($job_id, $export_id, string $contentType = self::contentTypes['getEmailBatchExportStatus'][0])
    {
        return $this->getEmailBatchExportStatusAsyncWithHttpInfo($job_id, $export_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getEmailBatchExportStatusAsyncWithHttpInfo
     *
     * Get Email Batch Export Status
     *
     * @param  string $job_id The unique identifier of the batch job. Format: uuid. Example: \&quot;84d22c8b-2cb6-4606-bfb1-361244a097e4\&quot;. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailBatchExportStatusAsyncWithHttpInfo($job_id, $export_id, string $contentType = self::contentTypes['getEmailBatchExportStatus'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getEmailBatchExportStatusRequest($job_id, $export_id, string $contentType = self::contentTypes['getEmailBatchExportStatus'][0])
    {

        // verify the required parameter 'job_id' is set
        if ($job_id === null || (is_array($job_id) && count($job_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $job_id when calling getEmailBatchExportStatus'
            );
        }
        ...
        if ($export_id === null || (is_array($export_id) && count($export_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $export_id when calling getEmailBatchExportStatus'
            );
        }

        $resourcePath = '/email/batch/{jobId}/exports/{exportId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->getEmailBatchStatusWithHttpInfo($job_id, $contentType);
        return $response;
    }
