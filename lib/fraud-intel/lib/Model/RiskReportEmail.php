...
class RiskReportEmail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets score
     *
     * @param int|null $score Risk score normalized and clamped to the 200–1000 range.
     *
     * @return self
     */
    public function setScore($score)
    {
        ...
        if (($score > 1000)) {
            throw new \InvalidArgumentException('invalid value for $score when calling RiskReportEmail., must be smaller than or equal to 1000.');
        }
        if (($score < 200)) {
            throw new \InvalidArgumentException('invalid value for $score when calling RiskReportEmail., must be bigger than or equal to 200.');
        }
     ...
     * Sets base_analysis
     *
     * @param string[]|null $base_analysis Provide the breakdown of the highest-weight risk factors used in the analysis. Additional lower-weight signals may exist outside this array.
     *
     * @return self
     */
