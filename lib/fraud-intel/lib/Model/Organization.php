...
class Organization implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * Sets descr
     *
     * @param  string[]|null  $descr  Organization description. It might return different values based on the data source. Some provide ownership, address, others provide a more abstract description. Our system tries to sanitize removing…
     * @return self
     */
