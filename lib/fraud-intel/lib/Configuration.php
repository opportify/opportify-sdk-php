...
namespace OpenAPI\FraudIntel\Client;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.opportify.ai/intel/v1';
    ...
    {
        $report  = 'PHP SDK (OpenAPI\FraudIntel\Client) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://api.opportify.ai/intel/v1",
